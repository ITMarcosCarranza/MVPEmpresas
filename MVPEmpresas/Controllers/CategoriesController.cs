...
namespace MVPEmpresas.Controllers
{
    public class CategoriesController : Controller
    {
        private readonly EmpresasDbContext _context;

        public CategoriesController(EmpresasDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Category != null ? 
                          ...
                          Problem("Entity set 'EmpresasDbContext.Category'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EmpresasDbContext.Category'  is null.");
            }
            var category = await _context.Category.FindAsync(id);
            if (category != null)
            {
